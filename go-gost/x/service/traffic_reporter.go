...
var httpTlsSkipVerify bool           // 是否跳过TLS证书验证
	...
	client := &http.Client{
		...
		Transport: &http.Transport{
			TLSClientConfig: &cryptotls.Config{
				InsecureSkipVerify: httpTlsSkipVerify,
			},
		},
	}
